...
<CardGroup cols={2}>
  ...
  <Card title="Team Settings" icon="gear" href="/core/teams/settings">
    Configure team name and settings
  </Card>
  <Card title="Invitations" icon="envelope" href="/core/teams/invitations">
    Understand the invitation system
  </Card>
</CardGroup>
