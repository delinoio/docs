...
<CardGroup cols={2}>
  <Card title="Pricing Details" icon="tag" href="/core/billing/pricing">
    Understand service pricing and usage charges
  </Card>
  ...
  <Card title="Payment Methods" icon="credit-card" href="/core/billing/payment-methods">
    Manage payment methods via Polar.sh
  </Card>
</CardGroup>
