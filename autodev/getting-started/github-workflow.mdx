...
description: "Set up the AutoDev GitHub Workflow in your repository to automate development tasks"
---

## Prerequisites

Before you begin, ensure you have:
- Completed the [GitHub App installation](/autodev/getting-started/github-app)
...
Replace these with your project's build or setup requirements. For reference, the Delino monorepo includes steps like
...
Once the workflow is set up, you can start using AutoDev to automate development tasks. Learn how to trigger your first AutoDev task in the [Creating your first PR](/autodev/getting-started/first-pr) guide.
