...
2. Verify auto-undraft is enabled in [Settings](/autodev/settings)
...
See [Auto-apply Bot Reviews](/autodev/settings#auto-apply-bot-reviews) in the settings documentation for details on enabling this feature.
