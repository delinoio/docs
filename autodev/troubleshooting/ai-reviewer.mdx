...
Auto-apply bot reviews may be disabled. See [troubleshooting bot reviews](/autodev/settings/index#bot-reviews-not-triggering-workflows) in the settings documentation for complete troubleshooting steps.
...
For best practices on configuring bot reviews, monitoring costs, and regular auditing, see the [Auto-apply Bot Reviews configuration tips](/autodev/settings/index#configuration-tips) in the settings documentation.
